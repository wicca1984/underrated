...
LOG=/workspaces/toy-browser/var/log/t0415-retry.log
mkdir -p /workspaces/toy-browser/var/log
read -r -d '' PROMPT <<'EOF' || true
EXECUTE IMMEDIATELY. Do not ask for confirmation. Do not stop at a plan. Implement, build, test, then commit.

CRITICAL: Do NOT use web search or any web tool. The full algorithm you need is spelled out below — implement it directly from this prompt and the local source files only. Reading local files is fine; network/web search is forbidden and wastes time.
