...
pub fn sniff_response(
    ...
    if charset.is_none() {
        ...
        charset = match sniffed_charset {
            ...
            crate::encoding::Charset::Iso8859_1 => Some("iso-8859-1".to_string()),
            ...
            crate::encoding::Charset::Iso8859_7 => Some("iso-8859-7".to_string()),
            crate::encoding::Charset::Iso8859_13 => Some("iso-8859-13".to_string()),
            crate::encoding::Charset::Iso8859_10 => Some("iso-8859-10".to_string()),
            crate::encoding::Charset::Iso8859_16 => Some("iso-8859-16".to_string()),
            crate::encoding::Charset::Iso8859_9 => Some("iso-8859-9".to_string()),
            ...
            crate::encoding::Charset::XUserDefined => Some("x-user-defined".to_string()),
        };
    }
